...
export const jobExperience: JobItem[] = [
  ...
  },
  {
    ...
    comments: [
      ...
      `Collaborated with teams using: VB C#, ASP.NET, MS SQL Server, JavaScript, JSON, CSS, HTML/XHTML, Visual Studio,  Team Foundation Server.`,
      `Created and maintained test cases and test plans for applications.`,
      `Attained and maintained security clearances needed for my role as a DOD employee.`,
      `Attended training and worked directly with soldiers and other stakeholders to create use cases and gain insight in how my products would be used.`,
    ],
  },
  {
    id: 5,
    ...
    location: 'Buffalo, NY ',
    comments: [
      `Lead the technical side of a startup that created web applications to buy and sell textbooks`,
      `Developed applications using: PHP, Java, JavaScript, CSS, HTML, MySQL(versions 3.23 to 5.1), csv, xml, ANT`,
      `IDE: Eclipse, vim, Bugzilla.`,
    ],
  },
];